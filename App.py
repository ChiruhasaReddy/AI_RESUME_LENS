...
from pdfminer.layout import LAParams, LTTextBox  # Updated import
from pdfminer.pdfpage import PDFPage  # Updated import
from pdfminer.pdfinterp import PDFResourceManager, PDFPageInterpreter  # Updated import
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Chiruhasa@13',db='sample')
